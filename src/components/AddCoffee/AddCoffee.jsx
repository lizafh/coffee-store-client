...
const handleAddCoffee = event => {
   ...
   {
    Swal.fire({
        title: 'Successfully Added a New Coffee!',
...
<div className="">
            ...
            <h1 className="text-4xl font-extrabold mt-12 text-center">Add New Coffee</h1> 
            </div>
    ...
    {/* row-4 */}
      <div className=" mx-3 ">
        ...
        <label >Photo URL</label>
          <input type="text" name="photo" className="input w-full" placeholder="Category" />
      ...
      <input type="submit" value="Add Coffee" className="btn bg-green-600 m-3 w-3/4 flex mx-auto " />
    </div>
